package main
{
	...
	{
		private var _id:int;
		private var _link:String = "http://www.taobao.com";	//链接地址
		private var _backColor:uint = 0xD96D00;				//背景色
		private var _frameColor:uint = 0;					//边框色
		//		private var _alpha:Number = .6;						//透明度
		private var _w:int;
		private var _h:int;
		...
		public function get isGouxuan():int
		{
			return _isGouxuan;
		}

		public function set isGouxuan(value:int):void
		{
			_isGouxuan = value;
		}
